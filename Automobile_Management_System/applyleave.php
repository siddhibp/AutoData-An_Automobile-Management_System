...
<html>
<head>
	<title>Apply Leave | Employee Panel | Automobile Management System</title>
	...
	<header>
		<nav>
			...
			<ul id="navli">
				...
				<li><a class="homeblack" href="http://localhost/SimpleAttendanceRecord/attendanceindex.php">Mark Attendance</a></li>
                <li><a class="homeblack" href="http://localhost/inventory-management-system/index.php">Inventory</a></li>
				<li><a class="homeblack" href="myprofile.php?id=<?php echo $id?>"">My Profile</a></li>
				<li><a class="homeblack" href="empproject.php?id=<?php echo $id?>"">My Targets</a></li>
